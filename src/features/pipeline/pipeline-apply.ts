import type { Renderer } from '../../shared/rendering/renderer.ts';
import type { ShaderBuildInput } from '../shader/shader-generator.ts';
import { buildFragmentShader, DEFAULT_VERT } from '../shader/shader-generator.ts';
