...
const TRANSLATIONS: Record<Language, TranslationSchema> = {
  ja: {
    ...
    'pipeline.paramGroup.constantDesc': '定数値',
    'pipeline.paramGroup.prevColorBadge': 'Prev Color',
    'pipeline.paramGroup.customParamsDesc': '外部uniformやBlenderのソケットとして公開されるグローバルなfloat入力',

    'pipeline.param.connectTitle': '{label} を接続',
    'pipeline.param.previewTooltip': '{label} の球体プレビュー',
    'pipeline.param.previewScale': '0 = 黒 / 1 = 白',
    'pipeline.param.remove': '削除',
    'pipeline.param.add': '追加',

    'pipeline.status.paramPreviewDrawFailed': 'Paramプレビューの描画に失敗しました: {message}',
    'pipeline.status.suppressClickFailed': 'クリック抑止判定に失敗しました。',
    'pipeline.step.empty': 'Stepがありません。下のStep追加ボタンで作成できます。',
    'pipeline.welcome.eyebrow': 'Empty Pipeline',
    'pipeline.welcome.title': 'LUT Chainer へようこそ',
    'pipeline.welcome.description': '.lutchain を読み込むか、example を開くか、GitHub から使い方を確認できます。',
    'pipeline.welcome.load': 'ファイルを読み込む',
    'pipeline.welcome.github': 'GitHub を開く',
    'pipeline.welcome.blenderAddon': 'Blender アドオンを入手する',
    'pipeline.welcome.examplesTitle': 'Examples',
    'pipeline.welcome.stepHint': '新規のパイプラインは、この直下にある「Step追加」ボタンから作れます。',
    ...
    'shader.status.exportSuccess': 'シェーダコードとLUT画像を ZIP として保存しました。',
    'shader.status.exportFailed': 'シェーダZIPの保存に失敗しました: {message}',

    'main.status.pipelineLoaded': 'パイプラインを読み込みました。',
    ...
    'main.status.lutDuplicated': 'LUT「{name}」を複製しました。',
    ...
    'main.status.shaderExportNotInitialized': 'シェーダエクスポートシステムが初期化されていません。',
    ...
    'lutEditor.title': 'LUT カラーランプ エディタ',
    'lutEditor.apply': '適用',
    'lutEditor.cancel': 'キャンセル',
    'lutEditor.addRamp': 'ランプ追加',
    'lutEditor.duplicateRamp': '複製',
    'lutEditor.invertRamp': '反転',
    'lutEditor.removeRamp': '削除',
    'lutEditor.addStop': 'ストップ追加',
    'lutEditor.duplicateStop': '複製',
    'lutEditor.invertStop': '反転',
    'lutEditor.removeStop': '削除',
    'lutEditor.rampPosition': '位置',
    'lutEditor.stopPosition': '位置',
    'lutEditor.alpha': 'アルファ',
    'lutEditor.rampListLabel': 'カラーランプ一覧',
    'lutEditor.stopEditorLabel': 'ストップ編集',
    'lutEditor.noRampSelected': 'ランプを選択してください',
    'lutEditor.stopColor': '色',
    'lutEditor.noStopSelected': 'ストップを選択してください',
    'lutEditor.rampDragHandle': 'ドラッグして順番を入れ替え',
    'lutEditor.rampMenuAria': 'カラーランプ操作メニューを開く',
    'lutEditor.rampRailHint': 'クリックでランプを追加 / ドラッグして右へ引き離すと削除',
    'lutEditor.stopMenuAria': 'ストップ操作メニューを開く',
    'lutEditor.stopRailHint': 'クリックでストップを追加 / ドラッグして下へ引き離すと削除',
    ...
    'lutEditor.axisStopXRampY': 'X: ストップ / Y: ランプ',
    'lutEditor.axisRampXStopY': 'X: ランプ / Y: ストップ',
    'pipeline.lut.editAria': '{name} を編集',
    'pipeline.lut.edit': '編集',
  ...
  en: {
    ...
    'pipeline.paramGroup.constantDesc': 'Constant values',
    'pipeline.paramGroup.prevColorBadge': 'Prev Color',
    'pipeline.paramGroup.customParamsDesc': 'Global float inputs exposed as external uniforms / Blender sockets.',

    'pipeline.param.connectTitle': 'Connect {label}',
    'pipeline.param.previewTooltip': '{label} sphere preview',
    'pipeline.param.previewScale': '0 = black / 1 = white',
    'pipeline.param.remove': 'Remove',
    'pipeline.param.add': 'Add Param',

    'pipeline.status.paramPreviewDrawFailed': 'Failed to draw the parameter preview: {message}',
    ...
    'pipeline.welcome.eyebrow': 'Empty Pipeline',
    'pipeline.welcome.title': 'Welcome to LUT Chainer',
    'pipeline.welcome.description': 'Load a .lutchain file, open an example, or check GitHub for usage details.',
    'pipeline.welcome.load': 'Load File',
    'pipeline.welcome.github': 'Open GitHub',
    'pipeline.welcome.blenderAddon': 'Download Blender Add-on',
    'pipeline.welcome.examplesTitle': 'Examples',
    'pipeline.welcome.stepHint': 'Create a new pipeline from the "Add Step" button right below this welcome panel.',
    ...
    'shader.status.exportSuccess': 'Saved shader code and LUT images as a ZIP archive.',
    'shader.status.exportFailed': 'Failed to export shader ZIP: {message}',

    'main.status.pipelineLoaded': 'Pipeline loaded.',
    ...
    'main.status.lutDuplicated': 'Duplicated LUT "{name}".',
    ...
    'main.status.shaderExportNotInitialized': 'Shader export system is not initialized.',
    ...
    'lutEditor.title': 'LUT Color Ramp Editor',
    'lutEditor.apply': 'Apply',
    'lutEditor.cancel': 'Cancel',
    'lutEditor.addRamp': 'Add Ramp',
    'lutEditor.duplicateRamp': 'Duplicate',
    'lutEditor.invertRamp': 'Invert',
    'lutEditor.removeRamp': 'Remove',
    'lutEditor.addStop': 'Add Stop',
    'lutEditor.duplicateStop': 'Duplicate',
    'lutEditor.invertStop': 'Invert',
    'lutEditor.removeStop': 'Remove',
    'lutEditor.rampPosition': 'Position',
    'lutEditor.stopPosition': 'Position',
    'lutEditor.alpha': 'Alpha',
    'lutEditor.rampListLabel': 'Color Ramps',
    'lutEditor.stopEditorLabel': 'Stop Editor',
    'lutEditor.noRampSelected': 'Select a ramp to edit',
    'lutEditor.stopColor': 'Color',
    'lutEditor.noStopSelected': 'Select a stop knob to edit',
    'lutEditor.rampDragHandle': 'Drag to reorder',
    'lutEditor.rampMenuAria': 'Open color ramp actions',
    'lutEditor.rampRailHint': 'Click to add ramp / drag right off-rail to delete',
    'lutEditor.stopMenuAria': 'Open stop actions',
    'lutEditor.stopRailHint': 'Click to add stop / drag down off-rail to delete',
    ...
    'lutEditor.axisStopXRampY': 'X: Stop / Y: Ramp',
    'lutEditor.axisRampXStopY': 'X: Ramp / Y: Stop',
    'pipeline.lut.editAria': 'Edit {name}',
    'pipeline.lut.edit': 'Edit',
...
function readStoredLanguage(): Language | null {
  return normalizeLanguageTag(readTextFromLocalStorage(STORAGE_KEY));
}
...
function persistLanguage(language: Language): void {
  ...
  writeTextToLocalStorage(STORAGE_KEY, language);
}
